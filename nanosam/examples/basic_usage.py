...
if __name__ == "__main__":
    ...
    image = PIL.Image.open("/home/xcdai/Documents/FoundationPose/demo_data/mark1/e2735.jpg")
    predictor.set_image(image)

    # Segment using bounding box
    #bbox = [100, 100, 850, 759]  # x0, y0, x1, y1
    #bbox = [600, 150, 1180, 759]  # x0, y0, x1, y1
    #bbox = [550, 500, 2250, 1675]  # x0, y0, x1, y1
    bbox = [426, 480, 850, 960]  # x0, y0, x1, y1
    ...
    plt.plot(x, y, 'g-')
    plt.savefig("data/basic_usage_out3.png")
